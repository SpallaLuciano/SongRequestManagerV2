...
namespace SongRequestManagerV2.Views
{
    ...
    public class SRMButton : BSMLAutomaticViewController, IInitializable
    {
        ...
        private async void ProcessSongRequest(SongRequest request, bool fromHistory = false)
        {
            ...
            Logger.Debug($"Queue size at process start: {RequestManager.RequestSongs.Count}");
            ...
            try {
                ...
                Logger.Debug($"Queue size after processing: {RequestManager.RequestSongs.Count}");
            }
        }
        ...
        public void PlaySongRequest(SongRequest request)
        {
            ...
            Logger.Debug($"Queue size before play: {RequestManager.RequestSongs.Count}");
